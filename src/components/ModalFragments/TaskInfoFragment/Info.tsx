...
import ChildrenTree from '../../ChildrenTreeModal/ChildrenTree';

const Info: React.FC<ITaskInfoFragment> = observer(({ modalClose }) => {
  ...
  return (
    <div>
      ...
      <div className={styles['flex-wrapper']}>
        ...
        <div className={styles['right-side']}>
          ...
          <div className={styles.tasks}>
            ...
            {!!todoStore.todos.find(t => t.parentTask === currentTodo?.id) && (
              <p
      ...
      <div className={styles.buttons}>
        <CButton type="button" size="smaller" cb={onSubmit} variant="primary">
          {isEqual(currentTodo, todoStore.selectedTodo) ? 'Ok!' : 'Apply'}
        </CButton>
        <CButton type="button" size="smaller" cb={onDelete} variant="tertiary">
          Delete Task
        </CButton>
        <CButton type="button" size="smaller" cb={onCancel} variant="secondary">
          Cancel
        </CButton>
      </div>
      {currentTodo?.id && (
